...
function calculateDogYears(years) {
  ...
  return "jouw hond is " + dogYears + " jaar oud in mensenjaren"
}
...
function creatDetailString(object) {
  return "Het beroep van " + object.firstname + " " + object.lastName +  " is " + object.profession + ".";
}

const objectDetail = creatDetailString({ firstname: "Jan", lastName: "Janssen", profession: "Docent" });
