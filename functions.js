...
function compliment() {
  return "Lekker bezig met de functies!"
}
...
const seeYourCijfers = getGrades()
console.log(seeYourCijfers);
...
function getDetails() {
  return { name: "Christina", lastName: "Guseva" };
}
const aboutMe = getDetails();
console.log(aboutMe);